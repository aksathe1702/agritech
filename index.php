...
<title>Agriculture Resource Portal</title>
<!--Bootstrap -->
...
<!-- Banners -->
<div id="banner class="banner-section2">
<center><img src="banner.jpg" width=1100px height=350px/></center>
<center><h1>Welcome to Agriculture Resource Booking Portal</h1></center>
</div>
<!-- /Banners --> 
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Resource For You Agriculture</span></h2>
      <p>Empower farmers to schedule <b>Agriculture resources <b>services effortlessly with our resource booking system for a more productive agriculture experience</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New Resource</a></li>
        </ul>
      </div>
